...
def train_net(args):
    ...
    train_dataset = CustomLaneDataset(images_dir='dataset/train/images', masks_dir='dataset/train/masks', valid=False)
    val_dataset = CustomLaneDataset(images_dir='dataset/val/images', masks_dir='dataset/val/masks', valid=True)
