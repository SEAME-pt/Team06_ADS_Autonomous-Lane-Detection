...
model_path = '/home/djoker/code/TwinLiteNet/linenet/outputs/nano/best_model.pth'
video_path = '/home/djoker/code/cuda/estrada.mp4'
video_path = 'http://100.93.45.188:8080/stream.mjpg'
output_path = 'output.mp4'
infer = LineNetVideoInference(model_path, variant='nano', device='auto')
