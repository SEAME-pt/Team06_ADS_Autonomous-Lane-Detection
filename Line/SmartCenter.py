...
class AdvancedLaneDetector:
    def __init__(self):
        ...
        self.roi_height_ratio = 0.8  # Proporção da altura para ROI
        ...
        while self.running:
            try:
                ...
                if deviation is not None:
                    ...
                    base_speed_normalized = self.car_config.base_speed / 5.0  # Assuming max speed was around 10
                    ...
                    #self.car.drive(0,steering_angle)
